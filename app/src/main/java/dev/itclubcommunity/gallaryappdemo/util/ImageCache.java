...
package dev.itclubcommunity.gallaryappdemo.util;
...
import dev.itclubcommunity.gallaryappdemo.util.DiskLruCache;
...
public class ImageCache {
    ...
    private void init(ImageCacheParams cacheParams) {
        ...
        if (mCacheParams.memoryCacheEnabled) {
            ...
            if (dev.itclubcommunity.gallaryappdemo.util.Utils.hasHoneycomb()) {
                mReusableBitmaps =
